...
<div class="questionnaires form">
    <?php echo $this->Form->create('Questionnaire', array('type' => 'file', 'url' => array('action' => 'add'))); ?>
    <legend><?php echo __('Créer une mission'); ?></legend>
    <fieldset>
        <?php
        ...
        <div class="input text required" style="margin-bottom:30px;">
            ...
            <input type="text" id="amounte" readonly style="border:0; color:#777; font-weight:bold;background:none;box-shadow:none;width:55px;"><input type="hidden" id="val" name="data[Questionnaire][nombreuser]" value="30"></input>
        ...
        echo $this->Form->hidden('type', array('label' => 'Latitude', 'value' => 'client'));
        ?>
    </fieldset>
